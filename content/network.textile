...
** Each computer has an @IP address@ (phone number)
** DNS (phonebook) translates names like @www.google.com@ to IP addresses like @74.125.226.148@
# Find server program on computer
** Each server gets a @port number@ (mailbox)
